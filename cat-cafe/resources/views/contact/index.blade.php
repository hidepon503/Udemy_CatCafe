      ...
      <form action="{{ route('contact') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          @if($errors->has('name_kana'))
            <p class="text-pink-400 text-xs mt-2">{{ $errors->first('name_kana') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          @if($errors->has('phone'))
            <p class="text-pink-400 text-xs mt-2">{{ $errors->first('phone') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          @if($errors->has('email'))
            <p class="text-pink-400 text-xs mt-2">{{ $errors->first('email') }}</p>
          @endif
        </div>
        <div class="mb-4">
          ...
          @if($errors->has('body'))
            <p class="text-pink-400 text-xs mt-2">{{ $errors->first('body') }}</p>
          @endif
        </div>
